...
@section('content')
  <div class="flex-container">
    <div class="columns m-t-10">
      <div class="column">
        <h1 class="title">Vytvořit nová práva</h1>
      </div>
    </div>
    <hr class="m-t-0">
      ...
      <div class="column">
        <form action="{{route('permissions.store')}}" method="POST">
          ...
          <div class="block">
            <p class="control">
                <div class="field">
                  <b-radio v-model="permissionType" name="permission_type" native-value="crud">CRUD práva (vytvořit, číst, aktualizovat, smazat)</b-radio>
                </div>
                <div class="field">
                  <b-radio v-model="permissionType" name="permission_type" native-value="basic">Základní práva</b-radio>
                </div>
              </p>
          </div>
          ...
          <div class="columns" v-if="permissionType == 'crud'">
            ...
            <div class="column">
              <!-- Permissions starts to appear when we type into Resource field at least 3 letter. -->
      ...
      var app = new Vue({
        ...
        methods: {
          ...
          crudDescription: function(item) {
            return "Povolit uživateli " + item.toUpperCase() + " " + app.resource.substr(0,1).toUpperCase() + app.resource.substr(1);
          }
        }
