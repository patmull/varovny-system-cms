...
@section('title', 'Upravit účet | Varovný systém ČR')
...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Účet
        <small>Upravit účet</small>
      </h1>
      <ol class="breadcrumb">
        <li>
          <a href="{{ route('home') }}"><i class="fa fa-dashboard"></i>Nástěnka</a>
        </li>
        <li class="active">Upravit účet</li>
      </ol>
    </section>
            ...
            <div class="box">
              ...
              <div class="box-body">
                ...
                {!! Form::model($userFound, [
                    ...
                    @include('administration.users.form', ['hideRoleDropdown' => true])
