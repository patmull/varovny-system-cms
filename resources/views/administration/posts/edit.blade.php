...
@section('title', 'Upravit příspěvek | Varovný systém ČR')
            ...
            <div class="box-body">
              {!!
                Form::model($postFound, [
                  'method' => 'PUT',
                  'route' => ['administration.posts.update', $postFound->slug],
                  'files' => TRUE,
                  'id' => 'post-form'
                ]) !!}
                ...
                <h3>Aktualizovat</h3>
                <p>
                    {!! Form::submit('Uložit změny', ['id' => 'new-post-btn', 'class' => 'btn btn-primary', 'name' => 'submitbutton', 'value' => '1'])!!}
