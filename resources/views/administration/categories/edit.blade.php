...
@section('title', 'Upravit kategorie | Varovný systém ČR')
        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="box">
              ...
              <div class="box-body">
                {!!
                  Form::model($categoryFound, [
                    'method' => 'PUT',
                    'route' => ['administration.categories.update', $categoryFound->slug],
                    'files' => FALSE,
                    'id' => 'category-form'
                  ]) !!}
                  ...
                  <h3>Aktualizovat</h3>
                  <p>
                    {!! Form::submit('Publikovat změny', ['class' => 'btn btn-primary'])!!}
                    {!! Form::close() !!}
